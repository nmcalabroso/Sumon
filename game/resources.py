...
class Resources:
	...
	sprites['title_bg_1'] 			= image.load(join(res_path,'title_bg_1.png'))
	sprites['title_bg_2'] 			= image.load(join(res_path,'title_bg_2.png'))
	sprites['main_bg'] 				= image.load(join(res_path,'main_bg.png'))
	sprites['main_bg_1'] 			= image.load(join(res_path,'main_bg_1.png'))
	sprites['main_bg_2'] 			= image.load(join(res_path,'main_bg_2.png'))
